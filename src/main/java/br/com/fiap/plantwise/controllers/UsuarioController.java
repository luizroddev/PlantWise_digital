...
import br.com.fiap.plantwise.records.UsuarioLogin;
...
public class UsuarioController {
    ...
    @GetMapping
    public PagedModel<EntityModel<Object>> index(@RequestParam(required = false) String nome, @PageableDefault(size = 5) Pageable pageable){
        log.info("Buscando usuários");

        Page<Usuario> usuarios = (nome == null) ?
